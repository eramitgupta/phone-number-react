...
//#endregion
//#region src/types/helpers.ts
function a(e) {
	return String(e == null ? "" : e).trim().toLowerCase().replace(/[^a-z0-9]+/gi, "-").replace(/^-+|-+$/g, "");
}
function o(e = [], t) {
	let n = a(t);
	return e.find((e) => [
		...
		e.iso2,
		e.iso3
	].filter(Boolean).some((e) => a(e) === n));
}
function s(e = [], t) {
	var n;
	let r = o(e, t), i = r == null || (n = r.countryCodes) == null ? void 0 : n[0];
	return i ? `+${i}` : null;
}
function c(e = [], t) {
	var n, r, i, a, s, c;
	let l = o(e, t), u = f((n = (r = (i = (a = (s = l == null ? void 0 : l.phone_lengths) == null ? l == null ? void 0 : l.phoneLengths : s) == null ? l == null ? void 0 : l.phone_length : a) == null ? l == null ? void 0 : l.phoneLength : i) == null ? l == null ? void 0 : l.phone_max_length : r) == null ? l == null ? void 0 : l.phoneMaxLength : n);
	if (u.length > 0) return u;
	let d = p(l);
	return (c = d == null ? void 0 : d.lengths) == null ? [] : c;
}
function l(e = [], t) {
	let n = c(e, t), r = s(e, t);
	return n.length > 0 ? Math.max(...n) : r ? Math.max(1, 15 - r.replace(/\D/g, "").length) : null;
}
function u(e = [], t, n) {
	var r;
	let i = s(e, t), a = (r = i == null ? void 0 : i.replace(/\D/g, "")) == null ? "" : r, o = n.replace(/\D/g, ""), c = a && o.startsWith(a) ? o.slice(a.length) : o, u = l(e, t);
	return u ? c.slice(0, u) : c;
}
function d(e = [], t) {
	var n, r;
	let i = s(e, t), a = o(e, t), c = p(a), l = h(a), u = Math.max(...(n = c == null ? void 0 : c.lengths) == null ? [10] : n);
	return i ? (l === "US" || l === "CA") && u === 10 ? `${i} (###) ###-####` : l === "IN" && u === 10 ? `${i} ##### #####` : `${i} ${m((r = c == null ? void 0 : c.groups) == null ? [u] : r)}` : "#".repeat(u);
}
function f(e) {
	return (Array.isArray(e) ? e : [e]).map((e) => Number(e)).filter((e) => Number.isInteger(e) && e > 0);
}
function p(e) {
	var t;
	let n = h(e);
	return n ? (t = i[n]) == null ? null : t : null;
}
function m(e) {
...
function h(e) {
	var t, n;
	let r = String((t = (n = e == null ? void 0 : e.isoCode2) == null ? e == null ? void 0 : e.iso2 : n) == null ? "" : t).toUpperCase();
	return /^[A-Z]{2}$/.test(r) ? r : null;
}
//#endregion
//#region src/usePhoneNumber.ts
function g(t = r) {
	var n, i, a;
	let l = (n = (i = t.countries) == null ? r.countries : i) == null ? [] : n, [f, p] = e((a = t.countryCode) == null ? "IN" : a), [m, h] = e(() => {
		var e;
		return u(l, f, (e = t.phone) == null ? "" : e);
	}), g = c(l, f), b = o(l, f), x = s(l, f), S = d(l, f), C = m.length > 0 && g.includes(m.length), w = (e) => {
		if (y(e)) return T(e), m.length > 0 && g.includes(m.length);
		let t = v(e), n = u(l, f, _(e)), r = n.length > 0 && g.includes(n.length);
		return h(n), t && (t.value = n), r;
	}, T = (e) => {
		let t = _(e);
		p(t), h((e) => u(l, t, e));
	};
...
function _(e) {
	...
	if (y(e)) {
		var r, i, a;
		return String((r = (i = (a = e.isoCode2) == null ? e.iso2 : a) == null ? e.key : i) == null ? e.name : r);
	}
	return String((t = (n = v(e)) == null ? void 0 : n.value) == null ? "" : t);
}
function v(e) {
...
function y(e) {
	return typeof e == "object" && !!e && ("key" in e || "isoCode2" in e);
}
//#endregion
export { t as countries, n as dialCodes, r as phoneNumberData, g as usePhoneNumber };
